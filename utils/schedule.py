...
# def linear_warmup_cosine_decay(end_ratio=0.01, warmup_steps=1600, **kwargs):
#     """
...
def linear_warmup_cosine_decay(end_ratio=0.01, warmup_steps=3200, **kwargs):
    def schedule(optimizer, train_loader, epochs, last_epoch):
        total_steps = epochs * len(train_loader)
        ...
        def lr_lambda(current_step):
            ...
            return max(end_ratio, 0.5 * (1.0 + math.cos(math.pi * progress)))
